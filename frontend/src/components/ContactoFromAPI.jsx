      ...
      <div className="max-w-5xl mx-auto px-5 w-full">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch mt-4 md:mt-8">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-6 flex flex-nowrap gap-1.5 md:gap-3 max-w-full overflow-hidden">
              <a href={`https://wa.me/${contacto.whatsapp}`} target="_blank" rel="noreferrer" className="flex-1 min-w-0 md:flex-none inline-flex items-center justify-center gap-1 text-white font-medium px-2 py-2 text-[11px] md:px-5 md:py-2.5 md:text-[13px] md:w-[150px] rounded-full transition whitespace-nowrap hover:brightness-95" style={{ backgroundColor: "#25D366" }}><WhatsAppIcon size={14} /> WhatsApp</a>
              <a href={`mailto:${contacto.email}`} aria-label={contacto.email} title={contacto.email} className="flex-1 min-w-0 md:flex-none inline-flex items-center justify-center gap-1 text-white font-medium px-2 py-2 text-[11px] md:px-5 md:py-2.5 md:text-[13px] md:w-[150px] rounded-full transition whitespace-nowrap hover:brightness-95" style={{ backgroundColor: "#EA4335" }}><Mail size={14} /> Email</a>
              <a href={contacto.instagram} target="_blank" rel="noreferrer" aria-label="Instagram" title="Instagram" className="flex-1 min-w-0 md:flex-none inline-flex items-center justify-center gap-1 text-white font-medium px-2 py-2 text-[11px] md:px-5 md:py-2.5 md:text-[13px] md:w-[150px] rounded-full transition whitespace-nowrap hover:brightness-95" style={{ background: "linear-gradient(45deg, #f9ce34, #ee2a7b, #6228d7)" }}><InstagramIcon size={14} /> Instagram</a>
            </div>
