  ...
  return (
    <section id="contacto" className="bg-lila-50/60 py-16 md:py-24 scroll-mt-20">
      <div className="max-w-5xl mx-auto px-5 w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 items-stretch mt-4 md:mt-8">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-6 grid grid-cols-3 gap-1.5 md:gap-2">
              <a href={`https://wa.me/${contacto.whatsapp}`} target="_blank" rel="noreferrer" className="min-w-0 inline-flex items-center justify-center gap-1 text-white font-medium px-1 py-2.5 text-[10px] md:text-xs rounded-full transition whitespace-nowrap overflow-hidden hover:brightness-95" style={{ backgroundColor: "#25D366" }}><WhatsAppIcon size={14} /> WhatsApp</a>
              <a href={`mailto:${contacto.email}`} aria-label={contacto.email} title={contacto.email} className="min-w-0 inline-flex items-center justify-center gap-1 text-white font-medium px-1 py-2.5 text-[10px] md:text-xs rounded-full transition whitespace-nowrap overflow-hidden hover:brightness-95" style={{ backgroundColor: "#EA4335" }}><Mail size={14} /> Email</a>
              <a href={contacto.instagram} target="_blank" rel="noreferrer" aria-label="Instagram" title="Instagram" className="min-w-0 inline-flex items-center justify-center gap-1 text-white font-medium px-1 py-2.5 text-[10px] md:text-xs rounded-full transition whitespace-nowrap overflow-hidden hover:brightness-95" style={{ background: "linear-gradient(45deg, #f9ce34, #ee2a7b, #6228d7)" }}><InstagramIcon size={14} /> Instagram</a>
            </div>
